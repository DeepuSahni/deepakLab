...
public class AddressController {
    ...
    public String fetchAndStorefromServer(final @PathVariable Long serverPort) {
       Address address = null;
       try {
           // Connect and fetch data from server
           address = restTemplate.getForObject("http://localhost:" + serverPort + SERVER_GET_ADDRESS, Address.class);
       }
